...
public class EmployeeManagementSystemApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        System.out.println("---- Interface-based Projection (Name + Email) ----");
        List<EmployeeNameEmailView> nameEmailViews = employeeRepository.findProjectedBy();
        for (EmployeeNameEmailView view : nameEmailViews) {
            System.out.println("Name: " + view.getName() + ", Email: " + view.getEmail());
        }

        
        System.out.println("---- Class-based Projection (Name + Department Name) ----");
        List<EmployeeSummary> summaries = employeeRepository.fetchEmployeeSummaries();
        for (EmployeeSummary summary : summaries) {
            System.out.println("Name: " + summary.getName() + ", Department: " + summary.getDepartmentName());
        }
    }
}
